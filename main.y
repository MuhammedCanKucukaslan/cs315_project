...
EXPRESSION :  LP EXPRESSION RP 
    ...
    | VALUE // VAR_NAME or CONSTANT

// END OF Expressions

// Arithmetic
ARITHMETIC_EXPRESSION : ARITHMETIC_COMPOSITION
    | ARITHMETIC_FACTOR

ARITHMETIC_FACTOR: VAR_NAME
    | INTEGER
    | FLOAT_NUMBER
    | LP ARITHMETIC_EXPRESSION RP
    | FUNCTION_CALL 

ARITHMETIC_COMPOSITION : ARITHMETIC_FACTOR  MULTIPLICATIVE_OPERATOR ARITHMETIC_FACTOR
    | ARITHMETIC_COMPOSITION MULTIPLICATIVE_OPERATOR ARITHMETIC_FACTOR
    | ARITHMETIC_COMPOSITION MULTIPLICATIVE_OPERATOR ARITHMETIC_TERM

ARITHMETIC_TERM : ARITHMETIC_TERM ADDITIVE_OPERATOR ARITHMETIC_FACTOR 
	| ARITHMETIC_FACTOR ADDITIVE_OPERATOR ARITHMETIC_FACTOR
...
// Boolean 
LOGICAL_EXPRESSION :  LOGICAL_COMPOSITION
    | LOGICAL_FACTOR

LOGICAL_FACTOR: VAR_NAME
    | BOOLEAN_VAL
...
LOGICAL_COMPOSITION: LOGICAL_COMP_DUO
    | LOGICAL_COMPOSITION OR LOGICAL_FACTOR
    | LOGICAL_COMPOSITION OR LOGICAL_TERM

LOGICAL_TERM: LOGICAL_TERM_DUO
    | LOGICAL_TERM AND LOGICAL_FACTOR

LOGICAL_TERM_DUO: LOGICAL_FACTOR AND LOGICAL_FACTOR
LOGICAL_COMP_DUO: LOGICAL_FACTOR OR LOGICAL_FACTOR
